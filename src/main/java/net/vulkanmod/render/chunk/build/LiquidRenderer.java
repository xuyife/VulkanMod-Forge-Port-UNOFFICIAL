...
public class LiquidRenderer {
    ...
    public void tessellate(BlockState blockState, FluidState fluidState, BlockPos blockPos, TerrainBufferBuilder vertexConsumer) {
        ...
        final IClientFluidTypeExtensions handler = IClientFluidTypeExtensions.of(fluidState);
        ...
        sprites[0] = atlas.apply(handler.getStillTexture(fluidState, region, blockPos));
        sprites[1] = atlas.apply(handler.getFlowingTexture(fluidState, region, blockPos));
        var overlay = handler.getOverlayTexture(fluidState, region, blockPos);
