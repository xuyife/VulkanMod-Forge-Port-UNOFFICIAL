...
public class EffectInstanceM {
    ...
    @Unique
    String capturedVertexShader;

    @Unique
    String capturedFragmentShader;
    ...
    private JsonObject onParse(Reader pReader) {
        JsonObject jsonobject = GsonHelper.parse(pReader);
        this.capturedVertexShader = GsonHelper.getAsString(jsonobject, "vertex");
        this.capturedFragmentShader = GsonHelper.getAsString(jsonobject, "fragment");
    ...
    private void onUpdateLocations(EffectInstance instance) {
        instance.updateLocations();

        createShaders(resourceManager, capturedVertexShader, capturedFragmentShader);
    }
